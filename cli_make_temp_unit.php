...
$stmt = $pdo->prepare("INSERT INTO blood_inventory (unit_id, blood_type, collection_date, expiry_date, status, collection_site, storage_location, created_at) VALUES (?, 'O+', ?, ?, 'available', 'Main Center', 'Storage A', NOW())");
