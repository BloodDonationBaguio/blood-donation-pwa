...
if (!function_exists('tableExists')) {
    ...
    // ⚠️ COPY THIS FILE TO db.php AND UPDATE WITH YOUR ACTUAL CREDENTIALS!
    define('DB_TYPE', 'mysql'); // Using MySQL
    define('DB_HOST', 'localhost:3306'); // Change if different
    define('DB_NAME', 'blood_system'); // Your database name
