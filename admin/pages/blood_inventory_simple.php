<?php
/**
 * Simple Paginated Blood Inventory Management
 * Shows all blood units with donor information and pagination
 */
...
// Add seed_flag filter if column exists
try {
    $stmt = $pdo->query("SHOW COLUMNS FROM blood_inventory LIKE 'seed_flag'");
    if ($stmt->fetch()) {
        $whereConditions[] = 'bi.seed_flag = 0'; // Exclude test data by default
    }
} catch (Exception $e) {
            ...
            <form method="GET" class="row g-3" id="filterForm">
                ...
                <div class="col-md-3">
                    ...
                    <div class="d-flex gap-1">
                        ...
                        <a href="blood_inventory_simple.php" class="btn btn-outline-secondary">
        ...
        <div class="card-body p-0">
            <?php if (empty($bloodUnits)): ?>
                <div class="text-center py-5">
                    ...
                    <a href="blood_inventory_simple.php" class="btn btn-primary">Clear Filters</a>
                </div>
            <?php else: ?>
